...
def default_params(width=None, height=None, world_type=None, batch_size=None):
    ...
    params.tf_range = False  # tf_range=True compiles graph quicker but is slower when running.
    ...
    params.s_size_hidden = 10 * params.s_size_project
    ...
    params.train_iters = 10000  # 2000000  # just a large number - does not require this many steps
